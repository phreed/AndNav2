...
public abstract class OSMMapViewItemizedOverlayWithFocus<T extends OSMMapViewOverlayItem> 
extends OSMMapViewItemizedOverlay<T> 
{
	...
	private final Point mMarkerFocusedHotSpot;
	private Drawable mMarkerFocusedBase;
